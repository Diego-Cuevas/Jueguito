...
func _ready():
	...
	_cambiar_datos2()
func _construir():
	if GlobalVar.recursos["Investigacion"] >= GlobalVar.construcciones[cont2].instance().costo_investigacion && GlobalVar.recursos["Dinero"] >= GlobalVar.construcciones[cont2].instance().costo_dinero:
		GlobalVar.recursos["Investigacion"] -= GlobalVar.construcciones[cont2].instance().costo_investigacion
...
func _cambiar_datos2():
	...
	get_node("ConstruccionesLayer/ConstruccionesLayerint/VBoxContainer/NinePatchRect/CInvestigacion/text").text = str(GlobalVar.construcciones[cont2].instance().costo_investigacion)
